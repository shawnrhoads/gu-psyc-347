...
expName = 'prosocial-learning'  # from the Builder filename that created this script
expInfo = {'participant': ''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\12025\\Documents\\GitHub\\gu-psyc-347\\docs\\tasks\\prosocial-learning\\prosocial-learning.py',
...
intro_text = visual.TextStim(win=win, name='intro_text',
    text='In this experiment you will see two symbols appear on the screen and you need to select one of them.\n\nBased on your choices, you can win or lose points. Points are converted into REAL MONEY at the end of the experiment.\n\nPress SPACE to continue.',
    font='Arial',
...
instr_1 = visual.TextStim(win=win, name='instr_1',
    text='Some symbols will give you points more or less often than others. Your job is to figure out which symbol is the best to choose, and select it using your arrow keys. \n\nPress SPACE to continue.',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
instr_2 = visual.TextStim(win=win, name='instr_2',
    text='Respond using the LEFT and RIGHT arrow keys matching whichever side the symbol you choose appears. Sometimes the symbol might appear on the left while other times it might appear on the right. \n\nTry to respond as quickly and accurately as possible. You have about 2 seconds to make your choice.\n\nPress SPACE to continue.',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
instr_3 = visual.TextStim(win=win, name='instr_3',
    text='After each choice, you will see feedback. \n\nSometimes you will win points, +100 points!\nSometimes you will lose points, -100 points!\nSometimes you will not win or lose, 0 points\n\nPress SPACE to continue.',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
circle = visual.ImageStim(
    win=win,
    name='circle', 
    image='stimuli/circle.png', mask=None,
...
instr_4 = visual.TextStim(win=win, name='instr_4',
    text='Now you will play the task in two conditions: for YOURSELF and for ANOTHER PARTICIPANT.\n\nBoth you and the other participant start with 3 dollars, which you can lose from or add to up to 6 dollars.\n\nPress SPACE to continue.',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
ready_exp = visual.TextStim(win=win, name='ready_exp',
    text='Remember, your performance from now on will result in REAL MONETARY outcomes!\n\nWhen you are playing for yourself, you will receive any money you win. When you are playing for the other participant, they will receive any money you win for them. The other participant won’t know how much money you earn for them until they leave the experiment.\n\nPress SPACE to begin the experiment.',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
practice_round = data.TrialHandler(nReps=0, method='sequential', 
...
for thisPractice_round in practice_round:
    ...
    if key_resp.keys == 'left':
        ...
        # Offscreen
        circlePos = (0.0, 4.0)
    left_feedback.setImage(stim_left_name)
    right_feedback.setImage(stim_right_name)
    circle.setPos(circlePos)
    # keep track of which components have finished
    stimuli_feedbackComponents = [left_feedback, right_feedback, circle]
    ...
    practice_round.addData('circle.started', circle.tStartRefresh)
    practice_round.addData('circle.stopped', circle.tStopRefresh)
    ...
    if not key_resp.keys:
        ...
        thisExp.addData('cumulativePts_social', ptsSocial) 
        ...
        if key_resp.corr:
            if goal == "win":
                if condition == "self":
                    ...
                    outcome = "NEXT PARTICIPANT\n\n+100 points"
                    ptsSocial += 100
                    thisExp.addData('cumulativePts_social', ptsSocial)
                    thisExp.addData('cumulativePts_self', ptsSelf) 
                    thisExp.addData('outcomeDescr', "social win") 
                    thisExp.addData('outcome', 1)
                ...
                if condition == "self":
                    ...
                    thisExp.addData('cumulativePts_self', ptsSelf) 
                    thisExp.addData('cumulativePts_social', ptsSocial) 
                    thisExp.addData('outcomeDescr', "self avoid loss") 
                    ...
                    thisExp.addData('cumulativePts_social', ptsSocial)
                    thisExp.addData('cumulativePts_self', ptsSelf) 
                    thisExp.addData('outcomeDescr', "social avoid loss") 
                    thisExp.addData('outcome', 0)
            ...
            if goal == "win":
                if condition == "self":
                    ...
                    thisExp.addData('cumulativePts_social', ptsSocial) 
                    thisExp.addData('cumulativePts_self', ptsSelf)
                    thisExp.addData('outcomeDescr', "social avoid win") 
                    thisExp.addData('outcome', 0)
                ...
                if condition == "self":
                    ...
                    thisExp.addData('cumulativePts_self', ptsSelf) 
                    thisExp.addData('cumulativePts_social', ptsSocial) 
                    thisExp.addData('outcomeDescr', "self lose") 
                    thisExp.addData('outcome', -1)
                    ...
                    thisExp.addData('cumulativePts_social', ptsSocial) 
                    thisExp.addData('cumulativePts_self', ptsSelf)
                    thisExp.addData('outcomeDescr', "social lose") 
                    thisExp.addData('outcome', -1)
    ...
    if condition == "practice":
        ...
        thisExp.addData('cumulativePts_social', 1000) 
...
# completed 0 repeats of 'practice_round'
...
continueRoutine = True
# update component parameters for each repeat
if (ptsSelf > 0) and (ptsSocial > 0):
    end_result = f"You won {ptsSelf} points for YOURSELF!\n\nYou won {ptsSocial} points for the NEXT PARTICIPANT!"
elif (ptsSelf > 0) and not (ptsSocial > 0):
    end_result = f"You won {ptsSelf} points for YOURSELF!"
elif not (ptsSelf > 0) and (ptsSocial > 0):
    end_result = f"You won {ptsSocial} points for the NEXT PARTICIPANT!"
else:
    end_result = ""

...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\12025\\Documents\\GitHub\\gu-psyc-347\\docs\\tasks\\two-armed-bandit\\two-armed-bandit_lastrun.py',
...
for thisPractice_round in practice_round:
    ...
    routineTimer.add(0.500000)
    # update component parameters for each repeat
    left_feedback.setImage(stim_left_name_feedback)
    right_feedback.setImage(stim_right_name_feedback)
    # keep track of which components have finished

...
All course materials were designed to be modular. For example, if students are knowledgeable in Python basics and Jupyter Notebook (**Module 01**), then they could begin with model fitting (**Module 02**). If students are knowledgeable in model fitting with maximum likelihood estimation (**Module 02**), they could start with reinforcement learning (**Module 03**).
...
Links to example solutions for all exercises are provided on each page.
